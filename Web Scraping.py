...
for i in range(1,99):
        url = f'https://devnetproject.netlify.app/{i}'
        r = requests.get(url , headers={'odd' : random.choice("tr.odd")})
        soup = BeautifulSoup(r.content, 'html.parser')

        names = soup.findAll('div', class_="td.sorting_1")
        number = soup.findAll('div', class_="td")
